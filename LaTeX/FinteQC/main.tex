...
This observation motivates frequent batch auctions (FBAs), proposed by Budish, Cramton, and Shim~\cite{}. An FBA takes the basic idea of an opening or closing auction and applies it repeatedly throughout the trading day. Instead of matching orders continuously, the exchange collects orders over short intervals—for example, one second—and then clears each batch in a double-sided auction at a single price.
