...
We had to do range checks for the corresponding polynomials to the arrays in Table 1 that have a "++" beside them. The reason is to check the reliability of the data in the modular arithmetic. 
