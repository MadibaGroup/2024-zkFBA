...
This document covers `fba_protocol_100` and `fba_protocol_1000` -- Noir
circuits implementing all 33 constraints from `protocol_constraints.md`
(Section 14's Full Constraint List) for the zero-knowledge frequent batch
...
-- consistent with UltraHonk's constant verifier cost.
